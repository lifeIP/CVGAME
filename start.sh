...
g++ main.o EmptyBlock.o VoidButton.o CircleAddButton.o CircleButton.o -o sfml-app -lsfml-graphics -lsfml-window -lsfml-system `pkg-config opencv4 --cflags --libs`