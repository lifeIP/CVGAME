...
g++ -c ../src/components/buttons/circle/CircleIconButton/CircleIconButton.cpp -I /usr/include/opencv4

g++ -c ../src/components/visual/ShowCVImage/ShowCVImage.cpp -I /usr/include/opencv4
...
g++ main.o ShowCVImage.o RectButton.o EmptyBlock.o VoidButton.o CircleIconButton.o CircleAddButton.o CircleButton.o -o sfml-app -lsfml-graphics -lsfml-window -lsfml-system `pkg-config opencv4 --cflags --libs`
