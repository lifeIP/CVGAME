...
g++ main.o RectButton.o EmptyBlock.o VoidButton.o CircleIconButton.o CircleAddButton.o CircleButton.o -o sfml-app -lsfml-graphics -lsfml-window -lsfml-system `pkg-config opencv4 --cflags --libs`
